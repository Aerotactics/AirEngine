...
#pragma warning(disable:26812) // UNOFFICIAL EDIT
//The enum type 'tinyxml2::XMLError' is unscoped. Prefer 'enum class' over 'enum'
// + 2 more. We default to enum class anyways - Michael McCluskey (3/6/21)
